  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-8">
      <nav className="mb-3 text-xs">
        <Link href="/admin/admissions/leads" className="text-[var(--ds-primary)] hover:underline">
          ← Back to leads
        </Link>
      </nav>

      <header className="mb-6 rounded-2xl border border-[var(--ds-border)] bg-[var(--ds-surface)] p-6">
